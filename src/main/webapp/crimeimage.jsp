...
.buttoncd:hover span:after {
  ...
  right: 0;
    ...
    <br>
            <hr>
            <form action="fileuploads.jsp" method="post" enctype="multipart/form-data" style="display:flex;justify-content:center;flex-direction:column;margin:auto;width:20%;">
      ...
      <br>
      <input  type="text" name="cid" placeholder="Enter The ID to add Images">
      <br>
