 ...
 <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbs">
        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <h2>View  Officer</h2>
              <p>This page shows Details of Officers</p>
            </div>
          </div>
        </div>
      </div>
      <nav>
        <div class="container">
          <ol>
            <li><a href="viewofficer.jsp">Back</a></li>
...
margin-bottom:10px;
  ...
  flex-wrap: wrap;
   ...
   <h5 style="margin: 0 auto;display:flex;margin-bottom:10px;justify-content: space-around;flex-wrap: wrap;">Officer Records</h5>
       <br>
...
PreparedStatement psd=con.prepareStatement("select * from officer where pid="+q);
...
<br>
Join Date: <%out.print(rs.getString("date_of_joining"));%>
<br>
Station Name: <%out.print(rs.getString("station_name"));%>
<br>

station_ID: <%out.print(rs.getString("station_ID"));%>
<br>
</div>
