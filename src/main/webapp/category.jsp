  ...
  <main id="main">
    ...
    <div class="breadcrumbs">
      ...
      <nav>
        <div class="container">
          <ol>
            <li><h6>Select on a Crime Category to View  Complaint</h6></li>
...
<ul>
  ...
  <% try{
		...
		PreparedStatement psd=con.prepareStatement("select * from crimecategory");
		ResultSet rs=psd.executeQuery();
		   ...
		   while(rs.next())
		   {
			   %>
			 <li>  
			   <a style="color:black;" href="loadcomplaints.jsp?value=<%=rs.getString("crime_committed")%>"><%out.print(rs.getString("crime_committed"));%></a>
			   <br>
			   </li>
			   <%
  }
